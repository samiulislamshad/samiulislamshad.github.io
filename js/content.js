...
const PROJECTS = [
     ...
     ====================================================================== */
  {
    ...
    about: [
      ...
      'player. Between runs you return to the Nexus hub to build your kingdom, buy ' +
      'permanent upgrades and travel between planets.',

      'On a nine-developer team I own the combat and presentation layer — weapons, the ' +
      'player, animation, cutscenes, the hub, audio and the data layer.'
    ],
     ...
     ====================================================================== */
  {
    ...
    roles: [
      ...
      { name: 'Technical Artist',    detail: 'Light2D mine darkening, dynamic light sources, tilemap shadow and crack passes.' },
